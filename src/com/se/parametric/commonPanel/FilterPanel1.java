...
public class FilterPanel1 extends JPanel implements ActionListener
{
	...
	public FilterPanel1(String[] titleOfCombobox, ArrayList<Object[]> list, int width, int height,
			boolean isQA)
	{
...
//       allFilter.setBounds(0, 0, width, height);
		allFilter=new JPanel();
		allFilter.setLayout(null);
		allFilter.add(new JLabel("Ok"));
